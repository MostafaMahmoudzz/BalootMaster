...
public class BiddingUI : MonoBehaviour
{
    ...
    {
        Debug.Log($"[FIRST BIDDER DEBUG] BiddingUI received CurrentBidder: {evt.CurrentBidder?.Name}");
    ...
    {
        Debug.Log($"[FIRST BIDDER DEBUG] BiddingUI turn change - CurrentBidder: {evt.CurrentBidder?.Name}");
