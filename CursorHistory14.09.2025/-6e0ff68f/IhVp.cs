...
public class GameStage : Stage, IDeckOwner
{
    ...
    protected void DealCards()
    {
        ...
        // Debug: Verify anti-clockwise order
        Debug.Log($"[GameStage] Anti-clockwise verification:");
        Debug.Log($"[GameStage]   South (index 0) → Right should be East (index 3): {GetRightPlayer(m_players[0])?.Name}");
        Debug.Log($"[GameStage]   West (index 1) → Right should be South (index 0): {GetRightPlayer(m_players[1])?.Name}");
        Debug.Log($"[GameStage]   North (index 2) → Right should be West (index 1): {GetRightPlayer(m_players[2])?.Name}");
        Debug.Log($"[GameStage]   East (index 3) → Right should be North (index 2): {GetRightPlayer(m_players[3])?.Name}");
