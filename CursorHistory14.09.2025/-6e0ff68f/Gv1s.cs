...
public class GameStage : Stage, IDeckOwner
{
    ...
    void OnBiddingComplete(BiddingCompleteEvent evt)
    {
        ...
        else
        {
            ...
            Debug.Log("[GameStage] DISABLED FOR DEBUGGING: Would normally call StartRound() for no contract case");
            // DISABLED FOR DEBUGGING: StartRound();
        }
    }
    ...
    void OnBiddingNoBids(BiddingNoBidsEvent evt)
    {
        if (evt.BothRoundsNoBids)
        {
            ...
            // DISABLED FOR DEBUGGING: StartRound();
            Debug.Log("[GameStage] DISABLED FOR DEBUGGING: Would normally call StartRound()");
        }
    }
