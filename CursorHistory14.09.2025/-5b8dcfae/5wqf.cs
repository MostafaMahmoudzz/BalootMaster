...
public class BelootBiddingSystem
{
    ...
    {
        Debug.Log($"[BiddingSystem] === SubmitBid called ===");
        Debug.Log($"[BiddingSystem] Player: {player?.Name}, Bid: {bid?.ToString()}, Round: {m_currentRound}");
        Debug.Log($"[BiddingSystem] Current bidder: {CurrentBidder?.Name}, Bidding complete: {m_biddingComplete}");
