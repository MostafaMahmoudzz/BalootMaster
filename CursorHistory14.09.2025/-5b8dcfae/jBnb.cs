        ...
        if (bidsSubmitted >= m_biddingOrder.Count)
        {
            ...
            else if (m_currentRound == BiddingRound.Round2)
            {
                ...
                if (m_round1NoBids && m_round2NoBids)
                {
                    ...
                    Debug.Log("[BiddingSystem] TEMPORARILY DISABLED FOR DEBUGGING - staying in current bidding state");
                ...
                else
                {
                    ...
                    {
                        // Another Trump was chosen - finalize that Trump contract
                        Debug.Log("[BiddingSystem] Round 2 complete with Another Trump chosen - finalizing Trump contract");
                        m_biddingComplete = true;
                        FinalizeBidding();
                    }
                    else
