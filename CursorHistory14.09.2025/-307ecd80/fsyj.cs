...
public class AIPlayer : Player
{
    ...
    private Bid MakeBidDecision(Bid highestBid)
    {
        ...
        BelootBiddingSystem biddingSystem = Stage.m_biddingSystem;
    ...
    {
        // Round 1: Can only choose face-up card suit, Sun, or Pass
        Card32Family faceUpSuit = biddingSystem.FaceUpCard.Family;
        
        // 30% chance to take trump (face-up suit)
        if (highestBid == null && UnityEngine.Random.Range(0f, 1f) < 0.3f)
        {
