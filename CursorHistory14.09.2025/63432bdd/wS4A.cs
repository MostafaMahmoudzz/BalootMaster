...
public class BiddingStartEvent : PooledEvent
{
    ...
    public override void Reset()
    {
        CurrentBidder = null;
        HighestBid = null;
        Round = BelootBiddingSystem.BiddingRound.Round1;
        FaceUpCard = null;
    }
}
...
//-------------------------------------------------------
// BiddingAllPassedEvent
//-------------------------------------------------------
public class BiddingAllPassedEvent : PooledEvent
{
    public bool BothRoundsPassed { get; set; }

    public override void Reset()
    {
        BothRoundsPassed = false;
    }
}
